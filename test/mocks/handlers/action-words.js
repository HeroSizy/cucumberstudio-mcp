...
import { mockActionWords } from '../data/action-words.js';
...
export const actionWordHandlers = [
    ...
    http.get(`${BASE_URL}/projects/:projectId/actionwords`, ({ params, request }) => {
        ...
        if (tags) {
            ...
            filteredActionWords = filteredActionWords.filter((actionWord) => tagList.some((tag) => actionWord.tags.includes(tag.trim())));
        }
