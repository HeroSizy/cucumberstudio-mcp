...
import { mockScenarios, mockFolders } from '../data/scenarios.js';
...
export const scenarioHandlers = [
    ...
    http.get(`${BASE_URL}/projects/:projectId/scenarios`, ({ params, request }) => {
        ...
        if (tags) {
            ...
            filteredScenarios = filteredScenarios.filter((scenario) => tagList.some((tag) => scenario.tags.includes(tag.trim())));
        }
        if (folderId) {
