...
function registerProjectTools(server: McpServer, projectTools: ProjectTools): void {
  server.registerTool('cucumberstudio_list_projects', {
  ...
  server.registerTool('cucumberstudio_get_project', {
...
function registerScenarioTools(server: McpServer, scenarioTools: ScenarioTools): void {
  server.registerTool('cucumberstudio_list_scenarios', {
  ...
  server.registerTool('cucumberstudio_get_scenario', {
  ...
  server.registerTool('cucumberstudio_find_scenarios_by_tags', {
...
function registerActionWordTools(server: McpServer, actionWordTools: ActionWordTools): void {
  server.registerTool('cucumberstudio_list_action_words', {
  ...
  server.registerTool('cucumberstudio_get_action_word', {
  ...
  server.registerTool('cucumberstudio_find_action_words_by_tags', {
...
function registerTestRunTools(server: McpServer, testRunTools: TestRunTools): void {
  server.registerTool('cucumberstudio_list_test_runs', {
  ...
  server.registerTool('cucumberstudio_get_test_run', {
  ...
  server.registerTool('cucumberstudio_get_test_executions', {
  ...
  server.registerTool('cucumberstudio_list_builds', {
  ...
  server.registerTool('cucumberstudio_get_build', {
  ...
  server.registerTool('cucumberstudio_list_execution_environments', {
